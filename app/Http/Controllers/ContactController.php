...
class ContactController extends Controller
{
    ...
    private function indexCustomer()
    {
        ...
        $contacts = Datatables::of($query)
            ->addColumn('address', '{{implode(", ", array_filter([$address_line_1, $address_line_2, $city, $state, $country, $zip_code]))}}')
            ->addColumn('customer_route', '{{$customer_route}}')
        ...
        return $contacts->rawColumns(['action', 'opening_balance', 'credit_limit', 'pay_term', 'due', 'return_due', 'name', 'balance', 'customer_route'])
                        ->make(true);
    }
    ...
    public function create()
    {
        ...
        $customer_groups = CustomerGroup::forDropdown($business_id);
        $customer_routes = CustomerRoute::forDropdown($business_id);
        ...
        return view('contact.create')
            ->with(compact('types', 'customer_groups', 'customer_routes', 'selected_type', 'module_form_parts', 'users'));
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('contact.edit')
                ->with(compact('contact', 'types', 'customer_groups', 'customer_routes', 'opening_balance', 'users'));
        }
    }
