...
class Navigation
{
    ...
    private static function sales(): array
    {
        return self::group(__('sale.sale'), 'sell', [
            ...
            self::item(__('lang_v1.list_drafts'), ['App\Http\Controllers\SellController', 'getDrafts'], can: ['draft.view_all', 'draft.view_own'], module: 'add_sale'),
            ...
            self::item(__('lang_v1.list_quotations'), ['App\Http\Controllers\SellController', 'getQuotations'], can: ['quotation.view_all', 'quotation.view_own'], module: 'add_sale'),
