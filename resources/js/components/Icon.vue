...
const paths = {
    ...
    oil: ['M7 9h8l3 3v8H7V9Z', 'M10 9V6h3v3', 'M18 12l3-2', 'M11 14a1.5 1.5 0 0 0 1.5 3 1.5 1.5 0 0 0 1.5-3l-1.5-2-1.5 2Z'],
    ...
    print: ['M6 9V3h12v6', 'M6 18H4v-7h16v7h-2', 'M6 14h12v7H6v-7Z'],
    key: ['M15.5 8.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z', 'M12 12v9', 'M12 17h3', 'M12 20h2'],
    box: ['M21 8 12 3 3 8v8l9 5 9-5V8Z', 'M3 8l9 5 9-5', 'M12 13v8', 'M7.5 5.5l9 5'],
    cheque: ['M2 6h20v12H2V6Z', 'M6 10h6', 'M6 14h4', 'M15 14l4-4'],
    whatsapp: ['M3 21l1.7-4.6A8.5 8.5 0 1 1 8 20.2L3 21Z', 'M9 9.5c0 3 2.5 5.5 5.5 5.5l1-1.5-2-1-1 .8a4 4 0 0 1-2-2l.8-1-1-2L9 9.5Z'],
    grip: ['M9 6h.01', 'M15 6h.01', 'M9 12h.01', 'M15 12h.01', 'M9 18h.01', 'M15 18h.01'],
    download: ['M4 15v4a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-4', 'M12 3v12', 'm7 10 5 5 5-5'],
    wifiOff: ['M2 2l20 20', 'M8.5 16.5a5 5 0 0 1 7 0', 'M5 12.5a10 10 0 0 1 5.2-2.7', 'M19 12.5a10 10 0 0 0-2.3-1.6', 'M12 20h.01'],
};
