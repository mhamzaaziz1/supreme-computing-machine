        ...
        <div class="tw-flex tw-items-start tw-justify-between tw-gap-6 lg:tw-items-center">
            ...
            <div class="tw-flex tw-flex-wrap tw-items-center tw-justify-end tw-gap-3">
                ...
                <button type="button" data-theme-toggle
                    class="tw-inline-flex tw-items-center tw-justify-center tw-p-2 tw-rounded-lg tw-transition-colors tw-duration-200 hover:tw-bg-white/10 focus:tw-outline-none tw-ring-1 tw-ring-white/10 tw-text-white"
                    title="@lang('Toggle Theme')">
                    <!-- Sun icon (hidden in dark mode) -->
                    <svg class="tw-w-5 tw-h-5 tw-block dark:tw-hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <!-- Moon icon (hidden in light mode) -->
                    <svg class="tw-w-5 tw-h-5 tw-hidden dark:tw-block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
