		...
		<div class="form-group">
			<div class="input-group">
				...
				<span class="input-group-btn">
					...
					<button type="button" class="btn btn-default bg-white btn-flat" id="camera_barcode_btn" data-toggle="modal" data-target="#camera_barcode_modal" 
					title="Camera Barcode Scanner"><i class="fa fa-camera text-primary fa-lg"></i></button>
					<button type="button" class="btn btn-default bg-white btn-flat" data-toggle="tooltip" 
					title="Use your device's camera to scan product barcodes. Position the barcode in the center of the camera view for best results.">
					<i class="fa fa-question-circle text-info fa-lg"></i></button>
