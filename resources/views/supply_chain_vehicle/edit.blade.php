<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action([\App\Http\Controllers\SupplyChainVehicleController::class, 'update'], [$vehicle->id]), 'method' => 'put', 'id' => 'vehicle_edit_form' ]) !!}

    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang('lang_v1.edit_supply_chain_vehicle')</h4>
    </div>
